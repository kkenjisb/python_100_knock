# 問題 100 CSVファイルの調査
#
# 次のようなデータを持つ csv 形式ファイル "input.csv" からデータを読み込み、
# operation が "OP02_010" で記録されているデータを調べてください。
# 該当データに現れる user_id をすべて表示してください。
#
# 学習用サンプルは questions/data/q100_input.csv に置いてあります。
#
